...
class Tester:
    ...
    def run_test(self, step, test_function, rm_learned, rm_true, is_learned, q, num_agents, a_full,
                # swarm_reward_machine,
                   *test_args):
        
        # print('rm in tester', rm_learned)
        # exit()
        t_init = time.time()
       ...
       # reward_machines = self.get_reward_machines()
        ...
        for task_specification in self.get_task_specifications():
            ...
            reward = test_function(reward_machines, task_params, rm_learned, rm_true, is_learned, q, self.learning_params, self.testing_params, 14, num_agents, a_full,
                                   #swarm_reward_machine,
                                     *test_args)
