...
class Problem:
    ...
    def restart(self, N=None, alphabet=None):
        ...
        self.all_clauses = [] # this is a list(iterable(tuple(clause:list(var:int), weight:int|None)))
    ...
    def add_positive_antihints(self, dfas, weight=None):
        """
            :param dfas: there should exist words accepted by thoses languages that are not accepted by the automaton (not sub language).
            :type dfas: list(DFA)
    ...
    def add_negative_antihints(self, dfas, weight=None):
        """
            :param dfas: there should exist words rejected by thoses languages that are not rejected by the automaton (not sup language).
            :type dfas: list(DFA)
